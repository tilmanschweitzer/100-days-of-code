...
class Day12Test {
    ...
    public void extractAllNumbersFromString() {
        assertEquals(List.of(1, 2, 3), Day12.extractAllNumbersFromString("[1,2,3]"));
        assertEquals(List.of(2, 4), Day12.extractAllNumbersFromString("{\"a\":2,\"b\":4}"));
        assertEquals(List.of(3), Day12.extractAllNumbersFromString("[[[3]]]"));
        assertEquals(List.of(4, -1), Day12.extractAllNumbersFromString("{\"a\":{\"b\":4},\"c\":-1}"));
    }

    @Test
    public void sumAllNumbersInString() {
        assertEquals(6, Day12.sumAllNumbersInString("[1,2,3]"));
        assertEquals(6, Day12.sumAllNumbersInString("{\"a\":2,\"b\":4}"));
        assertEquals(3, Day12.sumAllNumbersInString("[[[3]]]"));
        assertEquals(0, Day12.sumAllNumbersInString("{\"a\":[-1,1]}"));
        assertEquals(0, Day12.sumAllNumbersInString("[-1,{\"a\":1}]"));
        assertEquals(0, Day12.sumAllNumbersInString("[]"));
        assertEquals(0, Day12.sumAllNumbersInString("{}"));
    }
