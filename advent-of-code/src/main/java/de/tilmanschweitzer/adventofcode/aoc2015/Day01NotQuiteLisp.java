...
public class Day01NotQuiteLisp extends SingleLineAdventOfCodeDay<List<Character>, Integer> {

    public Day01NotQuiteLisp() {
        super(2015, 1);
    }
    ...
    public int getFloorForInput(List<Character> line) {
        return sum(line.stream().map(Day01NotQuiteLisp::floorMoveForChar));
    }
