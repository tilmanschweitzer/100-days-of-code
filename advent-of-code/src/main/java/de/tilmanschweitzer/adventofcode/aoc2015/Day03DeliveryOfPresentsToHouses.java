...
public class Day03DeliveryOfPresentsToHouses extends SingleLineAdventOfCodeDay<List<Day03DeliveryOfPresentsToHouses.Move>, Integer> {

    public Day03DeliveryOfPresentsToHouses() {
        super(2015, 3);
    }
