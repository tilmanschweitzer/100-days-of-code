...
public class Day06AwardWinningLightInstructions extends MultiLineAdventOfCodeDay<Day06AwardWinningLightInstructions.LightInstruction, Long> {

    public Day06AwardWinningLightInstructions() {
        super(2015, 6);
    }
